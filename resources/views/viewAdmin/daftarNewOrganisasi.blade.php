  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Daftar New Organitation</li>
      </ol>
    ...
    <div class="card mb-3" style="margin: 20px;">
        <div class="card-header">
          <i class="fa fa-table"></i> Data New Organitation</div>
        <div class="card-body">
              ...
              <tbody>
                @foreach($dataOrganisasi as $data)
                  ...
                  <td>{{$data->bio}}</td>
              		<td>
                    <center>
                      <button class="btn btn-info " data-toggle="modal"  name="viewKtpPicture" data-target="#modal_view_license_picture_{{$data->id}}" data-toggle="tooltip" data-placement="right" title="Ktp Picture"><i class="fa fa-eye"></i></button>
                    </center>
                    <!-- Modal View KTP Picture-->
                      <div class="modal fade" id="modal_view_license_picture_{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalTambahDataLabel">license Picture dari nama : {{$data->name}}</h5>
                                ...
                                <div class="modal-body">
                                  <div class="row">
                                    <div class="col-md-12 campaign_pic">
                                      <center>
                                        <?php
                                          $pic_surat = $data->pic_surat;
                                          if($pic_surat == 0){
                                            $pic_surat = '/img/ktp_pic/ktp.jpg';
                                          }
                                        ?>
                                        <img src="{{$pic_surat}}" class="img-responsive" alt="" >
                                      </center>
                                    </div>
                                  </div>
