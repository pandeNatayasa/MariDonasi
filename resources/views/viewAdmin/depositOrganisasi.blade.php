  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Daftar New Deposit Group</li>
      </ol>
    ...
    <div class="card mb-3" style="margin: 20px;">
        <div class="card-header">
          <i class="fa fa-table"></i> Data New Deposit Group</div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered table-striped" id="data" width="100%" cellspacing="0">
              ...
              <tbody>
                <?php $no = 0;?>
                @foreach($dataNewDepositOrganisasi as $data)
              	<tr>
              		<td>{{$no=$no+1}}</td>
                  ...
                  <td>Rp. {{number_format($data->nominal)}}</td>
                    ...
                    <!-- Modal View Cover Campaign-->
              		...
              		<td>
              			<a href="{{route('validasi_deposit_organisasi',$data->id)}}" class="btn btn-primary " data-toggle="tooltip" data-placement="right" title="Validasi"><i class="fa fa-check"></i></a>
                            ...
                            <div class="modal-content">
                              <div class="modal-header">
                                ...
                                <div class="modal-footer">
                                  ...
                                  <form method="POST" action="{{route('delete_deposit_organisasi',$data->id)}}" >
                                  {{csrf_field()}}
    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Daftar Deposit Group</li>
      </ol>
      <!-- Example DataTables Card-->
    </div>
    <div class="card mb-3" style="margin: 20px;">
        <div class="card-header">
          <i class="fa fa-table"></i> Data Deposit Group</div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered table-striped" id="data" width="100%" cellspacing="0">
              <thead>
              ...
              <tbody>
                ...
                <?php $no = 0;?>
                @foreach($dataDepositOrganisasi as $data)
                <tr>
                  <td>{{$no=$no+1}}</td>
                  <td>{{$data->organisasi->name}}</td>
                  <td>Rp. {{number_format($data->nominal)}}</td>
