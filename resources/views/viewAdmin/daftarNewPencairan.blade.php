                ...
                @foreach($dataNewPencairan as $data )
                  ...
                  <td>Rp. {{number_format($data->nominal)}}</td>
                    ...
                    <!-- Modal View Detail Campaign-->
              		...
              		<td>
              			<a href="{{route('validasi_pencairan_dana_user',$data->id)}}" class="btn btn-primary " data-toggle="tooltip" data-placement="right" title="Validasi"><i class="fa fa-check"></i></a>
