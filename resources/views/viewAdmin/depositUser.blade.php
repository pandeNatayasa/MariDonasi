  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Daftar New Deposit User</li>
      </ol>
    ...
    <div class="card mb-3" style="margin: 20px;">
        <div class="card-header">
          <i class="fa fa-table"></i> Data New Deposit User</div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered table-striped" id="data" width="100%" cellspacing="0">
              ...
              <tbody>
                <?php $no = 0;?>
                @foreach($dataNewDepositUser as $data)
              	<tr>
              		<td>{{$no=$no+1}}</td>
                  ...
                  <td>Rp. {{number_format($data->nominal)}}</td>
                    ...
                    <!-- Modal View Cover Campaign-->
                                ...
                                <div class="modal-body">
                                  <div class="row">
                                    <div class="col-md-12 campaign_pic">
                                      <center>
                                        <img src="{{$data->pic_bukti_transfer}}" class="img-responsive" alt="" >
                                      </center>
                                    </div>
                                  </div>
              		...
              		<td>
              			<a href="{{route('validasi_deposit_user',$data->id)}}" class="btn btn-primary " data-toggle="tooltip" data-placement="right" title="Validasi"><i class="fa fa-check"></i></a>
                    ...
                    <!-- Modal Confirmation Delete-->
                      <div class="modal fade" id="modal_confirm_delete_{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalTambahDataLabel">Confirmation Delete Deposit</h5>
                                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">×</span>
                                </button>
                              </div>
                                ...
                                <div class="modal-body">
                                  <div class="row">
                                    <label class="control-label col-md-12">Apakah anda yakin akan menghapus deposit dengan data :</label>
                                  </div>
                                  <div class="row">
                                ...
                                <div class="modal-footer">
                                  ...
                                  <form method="POST" action="{{route('delete_deposit_user',$data->id)}}" >
                                  {{csrf_field()}}
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Daftar Deposit User</li>
      </ol>
      <!-- Example DataTables Card-->
      ...
      <div class="card mb-3" style="margin: 20px;">
        <div class="card-header" style="padding-top: 20px;">
          <i class="fa fa-table"></i> Data Deposit User</div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered table-striped" id="data" width="100%" cellspacing="0">
              <thead>
              ...
              <tbody>
                <?php $no = 0;?>
                @foreach($dataDepositUser as $data)
                <tr>
                  <td>{{$no=$no+1}}</td>
                  <td>{{$data->User->name}}</td>
                  <td>Rp. {{number_format($data->nominal)}}</td>
