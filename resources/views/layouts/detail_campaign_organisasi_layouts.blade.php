      ...
      <div class=" wow fadeInUp" data-wow-duration="500ms" data-wow-delay="250ms" style="padding-top: 40px;">
        ...
        <div class="card-body">
           <div class="table-responsive" style="margin-top: 10px;">
            <table class="table table-bordered table-striped table-hover display" id="table_donasi_barang">
              <thead style="background-color: black;">
                <tr>
                  <th style="color: #fff;">No</th>
                  <th style="color: #fff;">Nama Barang</th>
          ...
          <div class="modal fade" id="modal-form_barang{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <!-- method="post" action="{{route('campaign_user_barang.store')}}" -->
                  <form method="POST" enctype="multipart/form-data"  action="{{route('pencairan_barang_campaign_organisasi')}}" >
                  {{csrf_field()}}
                      <div class="row col-md-12">
