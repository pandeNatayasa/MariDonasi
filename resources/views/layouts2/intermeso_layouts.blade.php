    ...
    <section id="about">
      <div class="container">
        ...
        <header class="section-header wow fadeInUp" style="margin-top: 30px; margin-bottom: 200px;">
          <h3>Pemberitahuan</h3>
          <p>Silahkan Tunggu Untuk Divalidasi. Data anda sudah berhasil disimpan, silahkan menunggu untuk pemberitahuan selanjutnya atau hubungi admin untuk validasi lebih cepat, Terimaksih</p>
          <center>
            <a href="@yield('route_home')" class="btn btn-primary wow bounceInUp"> Back to Home</a>
          </center>
        </header>
