  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item " data-toggle="tooltip" data-placement="right" title="Daftar Campaign">
          <a class="nav-link" href="{{route('daftar-campaign')}}">
            <i class="fa fa-fw fa-table"></i>
            <span class="nav-link-text">Daftar Campaign</span>
          </a>
        </li>
        <li class="nav-item " data-toggle="tooltip" data-placement="right" title="Daftar Admin">
          <a class="nav-link" href="{{url('/datar-admin')}}">
            <i class="fa fa-fw fa-user"></i>
            <span class="nav-link-text">Daftar Admin</span>
          </a>
        </li>
        <li class="nav-item " data-toggle="tooltip" data-placement="right" title="Daftar User">
          <a class="nav-link" href="{{route('daftar-user')}}">
            <i class="fa fa-fw fa-user"></i>
            <span class="nav-link-text">Daftar User</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Transaksi Dana">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Daftar Pencairan Baru</li>
      </ol>
    ...
    <div class="card mb-3" style="margin: 20px;">
        <div class="card-header">
          <i class="fa fa-table"></i> Data Pencairan Baru</div>
        <div class="card-body">
