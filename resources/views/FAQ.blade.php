...
<body>
  ...
  <div id="intro" style="background-image: url({{asset('img/intro-carousel/slider-1.jpg')}});">
    <div class="text-center" style="left: 50%;top: 50%;padding: 120px;">
      <h1 style="color: #242628"><b>Syarat & Ketentuan</b></h1><br>
      <h5 style="color: #242628">Syarat dan ketentuan digunakan untuk mengikat para Pengunjung dan Pengguna Situs MariDonasi untuk mematuh atas apa yang telah ditetapkan oleh pihak pengelola situs. Dengan mengunjungi atau menggunakan situs MariDonasi, maka baik pengunjung maupun pengguna dinyatakan telah menyepakati semua isi dalam syarat dan ketentuan.</h5>
    </div>
  </div>
